...
import {_deleteAnnouncement} from "../../../redux/actions"
//************************************//
      ...
      return (
        <div className='d-flex'>
          <UncontrolledDropdown>
            ...
            <DropdownMenu right>
              <CanCall action='SETTINGS_EDIT_ANNOUNCEMENTS' id={`updateUser_${row.id}`}>
              ...
              <CanCall action='SETTINGS_DELETE_ANNOUNCEMENTS' id={`deleteUser_${row.id}`}>
...
const tableActions = ['SETTINGS_EDIT_ANNOUNCEMENTS', 'SETTINGS_DELETE_ANNOUNCEMENTS']
//************************************//
    ...
    return (
      <Fragment>
        <Breadcrumbs breadCrumbMainTitle={''} breadCrumbTitle={''} breadCrumbParent='' breadCrumbActive='' >
          <CanCall action='SETTINGS_ADD_ANNOUNCEMENTS' id='addUserBtn'>
        ...
        <Row>
          <Col sm='12'>
            <DataTable ref={(ref) => { this.dataTableRef = ref }} uri={'announcements'} columns={tableColumns(this.state, this._editBasicInfoModal, this._deleteUser, hasAction)} hasIndexing={true} hasFilter={false}/>
          </Col>
        </Row>
...
export default connect(mapStateToProps, null, null, { forwardRef: true })(AnnouncementsList)
