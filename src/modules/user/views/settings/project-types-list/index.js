...
import {_deleteProjectType} from "../../../redux/actions"
//************************************//
      ...
      return (
        <div className='d-flex'>
          <UncontrolledDropdown>
            ...
            <DropdownMenu right>
              <CanCall action='SETTINGS_EDIT_PROJECTTYPES' id={`updateUser_${row.id}`}>
              ...
              <CanCall action='SETTINGS_DELETE_PROJECTTYPES' id={`deleteUser_${row.id}`}>
...
const tableActions = ['SETTINGS_EDIT_PROJECTTYPES', 'SETTINGS_DELETE_PROJECTTYPES']
//************************************//
    ...
    return (
      <Fragment>
        <Breadcrumbs breadCrumbMainTitle={''} breadCrumbTitle={''} breadCrumbParent='' breadCrumbActive='' >
          <CanCall action='SETTINGS_ADD_PROJECTTYPES' id='addUserBtn'>
        ...
        <Row>
          <Col sm='12'>
            <DataTable ref={(ref) => { this.dataTableRef = ref }} uri={'projectTypes'} columns={tableColumns(this.state, this._editBasicInfoModal, this._deleteUser, hasAction)} hasIndexing={true} hasFilter={false}/>
          </Col>
        </Row>
...
export default connect(mapStateToProps, null, null, { forwardRef: true })(ProjectTypesList)
