      ...
      return (
        <div className='d-flex'>
          <UncontrolledDropdown>
            ...
            <DropdownMenu right>
              <CanCall action='SETTINGS_EDIT_PARTIES' id={`updateUser_${row.id}`}>
              ...
              <CanCall action='SETTINGS_DELETE_PARTIES' id={`deleteUser_${row.id}`}>
...
const tableActions = ['SETTINGS_EDIT_PARTIES', 'SETTINGS_DELETE_PARTIES']
//************************************//
    ...
    return (
      <Fragment>
        <Breadcrumbs breadCrumbMainTitle={''} breadCrumbTitle={''} breadCrumbParent='' breadCrumbActive='' >
          <CanCall action='SETTINGS_ADD_PARTIES' id='addUserBtn'>
...
export default connect(mapStateToProps, null, null, { forwardRef: true })(PartiesList)
